...
> java 编程思想第四版：2.2.2 节 ![img](Java基础相关常识.assets/86735519.jpg)
...
![example 1 ](Java基础相关常识.assets/22191348.jpg)
...
![example 2](Java基础相关常识.assets/3825204.jpg)
...
![img](Java基础相关常识.assets/88729818.jpg)

交换之后：

![img](Java基础相关常识.assets/34384414.jpg)
...
![img](Java基础相关常识.assets/desktopjava核心技术-重载.jpg)
...
![deep and shallow copy](Java基础相关常识.assets/java-deep-and-shallow-copy.jpg)
...
#### [2.4.6. 获取用键盘输入常用的两种方法](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java基础知识?id=_246-获取用键盘输入常用的两种方法)
...
![img](Java基础相关常识.assets/Java异常类层次结构图.png)

图片来自：https://simplesnippets.tech/exception-handling-in-java-part-1/

![img](Java基础相关常识.assets/Java异常类层次结构图2.png)
...
![check-exception](Java基础相关常识.assets/check-exception.png)
...
![Java线程的状态](Java基础相关常识.assets/Java线程的状态.png)

线程在生命周期中并不是固定处于某一个状态而是随着代码的执行在不同状态之间切换。Java 线程状态变迁如下图所示（图源《Java 并发编程艺术》4.1.4 节）：

![Java线程状态变迁](Java基础相关常识.assets/Java 线程状态变迁.png)
...
![RUNNABLE-VS-RUNNING](Java基础相关常识.assets/RUNNABLE-VS-RUNNING.png)
...
![IO-操作方式分类](Java基础相关常识.assets/IO-操作方式分类.png)

按操作对象分类结构图：

![IO-操作对象分类](Java基础相关常识.assets/IO-操作对象分类.png)
