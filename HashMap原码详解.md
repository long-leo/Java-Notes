[Skip to content](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#start-of-content)
...
## [JavaGuide](https://github.com/long-leo/JavaGuide)/[docs](https://github.com/long-leo/JavaGuide/tree/master/docs)/[java](https://github.com/long-leo/JavaGuide/tree/master/docs/java)/[collection](https://github.com/long-leo/JavaGuide/tree/master/docs/java/collection)/**HashMap(JDK1.8)源码+底层数据结构分析.md**
...
[Snailclimb](https://github.com/Snailclimb) [Update HashMap(JDK1.8)源码+底层数据结构分析.md](https://github.com/long-leo/JavaGuide/commit/7f9ba7ec6c43af2f9e448558410028530ff07ef7)



Latest commit [7f9ba7e](https://github.com/long-leo/JavaGuide/commit/7f9ba7ec6c43af2f9e448558410028530ff07ef7) 20 days ago[ **History**](https://github.com/long-leo/JavaGuide/commits/master/docs/java/collection/HashMap(JDK1.8)源码%2B底层数据结构分析.md)

 **1** contributor

578 lines (498 sloc) 22.7 KB

[Raw](https://github.com/long-leo/JavaGuide/raw/master/docs/java/collection/HashMap(JDK1.8)源码%2B底层数据结构分析.md)[Blame](https://github.com/long-leo/JavaGuide/blame/master/docs/java/collection/HashMap(JDK1.8)源码%2B底层数据结构分析.md)

 

- [HashMap 简介](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#hashmap-简介)
- 底层数据结构分析
  - [JDK1.8 之前](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#jdk18-之前)
  - [JDK1.8 之后](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#jdk18-之后)
- HashMap 源码分析
  - [构造方法](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#构造方法)
  - [put 方法](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#put-方法)
  - [get 方法](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#get-方法)
  - [resize 方法](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#resize-方法)
- [HashMap 常用方法测试](https://github.com/long-leo/JavaGuide/blob/master/docs/java/collection/HashMap(JDK1.8)源码+底层数据结构分析.md#hashmap-常用方法测试)
